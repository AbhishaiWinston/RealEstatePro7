...
loc_list=[]
with open('/Users/athekk875/Desktop/BHP/Model/loc_dict .pkl', 'rb') as loc_enc_open:
    loc_enc_dict = pickle.load(loc_enc_open)
with open('/Users/athekk875/Desktop/BHP/Model/area_type_means.pkl', 'rb') as area_enc_open:
